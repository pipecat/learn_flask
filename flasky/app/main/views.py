...
@main.route('/post/<int:id>', methods=['GET', '<POST></POST>'])
def post(id):
...
def followers(username):
    ...
    return render_template('followers.html', user=user, title="Follow of", endpoint='.followers', pagination=pagination, follows=follows)
...
def followed_by(username):
    ...
    return render_template('followers.html', user=user, title="Follow of", endpoint='.followed_by', pagination=pagination, follows=follows)
